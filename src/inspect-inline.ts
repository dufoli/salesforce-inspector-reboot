export function showStdPageDetails(metadataResponse : any, allFieldSetupLinks : any) {
  ...
  for (let labelEventElement of Array.from(document.querySelectorAll("td.labelCol, th.labelCol"))) {
    if (labelEventElement.textContent != null && labelEventElement.textContent.trim() != "") {
  ...
  function softShowFieldDetails(e: { currentTarget: any; }) {
    ...
    function Ea(name: string, attrs: { [x: string]: any; class?: string; href?: any; }, children: Node[]) {
    ...
    function E(name: string, children: Node[]) {
  ...
  function softHideFieldDetails(e: Event) {
  ...
  function makeFieldDetailsSticky(e: Event) {
    if (e.currentTarget == null || !(e.currentTarget instanceof Element)) {
        return;
    }
    let detailsElement = e.currentTarget.querySelector(".salesforce-inspector-details");
