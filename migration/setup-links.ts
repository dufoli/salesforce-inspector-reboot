...
export async function getObjectSetupLinks(sfHost: string, sobjectName: string) {
...
function getFieldDefinitionSetupLinks(sfHost: string, fieldName: string, fieldDefinition: { DurableId: string; }, isCustomSetting: boolean, isCustomMetadata: boolean) {
...
export async function getFieldSetupLinks(sfHost: string, sobjectName: string, fieldName: string, isCustomSetting: boolean) {
...
export async function getAllFieldSetupLinks(sfHost: string, sobjectName: any) {
